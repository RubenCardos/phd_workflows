...
from phd_workflows.src.scripts.elastic_patterns_incomes import execute_experiment

EXPERIMENT_NAME = "elastic_patterns_experiment_3"
...
DAG_ID = "elastic_patterns_experiment_3"
    ...
    for deformation_method in ["Hybrid", "Symmetric", "Asintotic", "Inverse"]:
        ...
        for group_function in ["mean", "min", "max"]:
            ...
            t_experiment = PythonOperator(
                                task_id=f"experiment_{group_function}_method_{deformation_method}",
